...
PROJECT_PATH = "project_new_andreas_zigzagpair"

# Model_0: 0130
IMAGE_PATH_0 = "dataset_andreas_park/andreas-park-20240130-images"  # INPUT HERE THE PATH TO THE FOLDER CONTAINING THE IMAGES FOR MODEL 1
IM_LIST_0 = "dataset_andreas_park/image_list_30zigzag.txt"  # OPTIONAL: add a txt file containing a list of images that should be used from IMAGE_PATH_0
gt_cam_file_0 = f"dataset_andreas_park/andreas-park-20240130-params/params/andreas-park-20240130-all_calibrated_external_camera_parameters.txt"
BIRD_EYE_PATH_0 = "dataset_andreas_park/bev_ground_truth_andreas_3001/ground_truth"  # INPUT HERE THE PATH TO THE BIRD EYE VIEWS (BEV) FOR MODEL
...
# Model_1,2: 0127
IMAGE_PATH_1 = "dataset_andreas_park/andreas-park-20240127"  # INPUT HERE THE PATH TO THE FOLDER CONTAINING THE IMAGES FOR MODEL 0
IM_LIST_1 = "dataset_andreas_park/image_list_27zigzag_1.txt"  # OPTIONAL: add a txt file containing a list of images that should be used from IMAGE_PATH_0
gt_cam_file_1 = f"dataset_andreas_park/andreas-park-20240127-params/andreas-park-20240127-all_calibrated_external_camera_parameters.txt"
# BIRD_EYE_PATH_1 = "dataset_andreas_park/bev_ground_truth_andreas_2701/ground_truth" # GT BEV
BIRD_EYE_PATH_1 = "dataset_andreas_park/dynamic_andreas3001_training_eval_andreas2701/dynamic_3001_training"  # Andreas training
...
IMAGE_PATH_2 = "dataset_andreas_park/andreas-park-20240127"  # INPUT HERE THE PATH TO THE FOLDER CONTAINING THE IMAGES FOR MODEL 0
IM_LIST_2 = "dataset_andreas_park/image_list_27zigzag_2.txt"  # OPTIONAL: add a txt file containing a list of images that should be used from IMAGE_PATH_0
