...
# ----------------------------------------------------------------------------
# Paths for local:
PROJECT_PATH = f"Dataset/Case_Different_Seasons/Project_seasons"  # INPUT HERE THE PATH THE TO YOUR PROJECT FOLDER (create a folder where you want the output of this pipeline to be stored)
...
config_file = 'Apple-Farm/config/config_diffseasons.json'
